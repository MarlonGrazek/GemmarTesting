...
// SVG-Konstanten bleiben unverändert...
...
// Globale Referenzen für Elemente, die direkt hier verwaltet werden.
let minimizeButton, maximizeButton, closeButton, themeManagerButton, appLogo, resultsPlaceholderLogo;
...
// Haupt-Initialisierungslogik, wenn das DOM geladen ist.
document.addEventListener('DOMContentLoaded', () => {
    ...
    // VEREINFACHUNG: Die Manager werden nun ohne Abhängigkeiten initialisiert.
    // Jeder Manager importiert den ModalManager bei Bedarf selbst.
    initializeUpdateRenderer();
    initializeThemeManager();
    initializeTestRunner();
    initializeTestUIManager({
        // Nur die Callback-Funktion wird noch übergeben, keine Manager mehr.
        onStartTest: (testConfig, files) => startTestRun(testConfig, files)
    });
    
    // TooltipManager global initialisieren.
    TooltipManager.init();
});
